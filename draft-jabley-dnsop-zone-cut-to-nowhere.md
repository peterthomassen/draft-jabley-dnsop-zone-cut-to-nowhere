...
1. "Zone cut to nowhere" -- a zone cut where the child zone is not
provisioned in the same DNS namespace as the parent. A zone
...
2. "Delegation to nowhere" -- a delegation from a parent for
...
target (marked with a comment as "unexpected"). This configuration may
